...
public:
    ...
    bool findPath(IXMLCStr path, IXMLChar sep='/', IXMLResults *r=NULL);      ///< read the data stream to reach a XML tag with the specified path
    bool findPathNonConst(IXMLStr path,IXMLChar sep='/', IXMLResults *r=NULL);///< read the data stream to reach a XML tag with the specified path
...
public:
    ...
    ICXMLNode getChildNodeWithAttribute(IXMLCStr tagName,
                                        ...
                                        IXMLCStr attributeValue=NULL,
                                        int *i=NULL)  const;         ///< return child node with specific name/attribute (return an empty node if failing)
    ICXMLNode getChildNodeByPath(IXMLCStr path, IXMLChar sep='/') const;   ///< return the first child node with specific path
...
public:
    ...
    IXMLNode getChildNodeWithAttribute(IXMLCStr tagName,
                                        ...
                                        IXMLCStr attributeValue=NULL,
                                        int *i=NULL)  const;         ///< return child node with specific name/attribute (return an empty node if failing)
    IXMLNode getChildNodeByPath(IXMLCStr path, IXMLChar sep='/')const;   ///< return the first child node with specific path
